...
(function() {
  ...
  function enhanceSelects(){
    ...
    selects.forEach(select=>{
      ...
      function openPanel(){
        ...
        // Lock body scroll when panel opens to prevent page drift
      ...
      function closePanel(){
        ...
        // Unlock only if no other panel is open
        if (!document.querySelector('.filter-select-panel.open')) {
          document.body.style.overflow = '';
        }
      }
  ...
  function renderRepliesFeed() {
    ...
    if (!replies.length) {
      listEl.innerHTML = '<div class="alert alert-info" style="background: rgba(10, 10, 10, 0.9); border: 1px solid rgba(13, 202, 240, 0.3); color: #ffffff;"><i class="fa-solid fa-circle-info"></i><font dir="auto" style="vertical-align: inherit;"><font dir="auto" style="vertical-align: inherit;"> Chưa có phản hồi từ cửa hàng.</font></font></div>';
      return;
    }
